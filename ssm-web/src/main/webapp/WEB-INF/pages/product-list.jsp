		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/product/findAll?page=1&size=4">产品管理</a></li>
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									<%-- 未分页：<c:forEach items="${productList}" var="product">--%>
									<%-- 查询所有产品信息都存储在 PageInfo对象的 list属性--%>
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs"
                                                	onclick="location.href='${pageContext.request.contextPath}/findOrdersByProductId?id=${product.id}'">订单
                                                </button>
												<button type="button" class="btn bg-olive btn-xs">编辑</button>
												<button type="button" class="btn bg-olive btn-xs"
													onclick="location.href='${pageContext.request.contextPath}/product/deleteProduct?id=${product.id}'">删除
												</button>
											</td>
										</tr>
									</c:forEach>
